...
exports.RepresentanteLegalService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const RepresentanteLegal_entity_1 = require("../entities/RepresentanteLegal.entity");
let RepresentanteLegalService = class RepresentanteLegalService {
    ...
    async findOne(id) {
        ...
        if (!representante) {
            throw new common_1.NotFoundException(`Representante Legal with ID ${id} not found`);
        }
...
exports.RepresentanteLegalService = RepresentanteLegalService;
exports.RepresentanteLegalService = RepresentanteLegalService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(RepresentanteLegal_entity_1.RepresentanteLegal)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], RepresentanteLegalService);
//# sourceMappingURL=representanteLegal.service.js.map